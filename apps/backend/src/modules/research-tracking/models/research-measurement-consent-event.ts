...
const ResearchMeasurementConsentEvent = model
  .define("research_measurement_consent_event", {
    id: model.id().primaryKey(),
    event_type: model.enum(["accepted", "withdrawn"]),
    ...
    profile: model.belongsTo(() => ResearchProfile, {
      mappedBy: "measurement_consent_events",
    }),
  })
  .indexes([
...
export default ResearchMeasurementConsentEvent
