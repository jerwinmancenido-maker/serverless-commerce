...
export const COMPOUNDED_PRODUCT_AUDIT_EVENT_TYPES = [
  ...
  "compound_family_created",
  "compound_family_updated",
  "compound_family_archived",
  "compound_family_assigned",
  "compound_family_unassigned",
  "compound_format_created",
  "compound_format_updated",
  "compound_format_archived",
  "compound_format_assigned",
  "compound_format_unassigned",
